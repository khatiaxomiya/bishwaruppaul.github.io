...
* **Teaching assistantship:**
    ...
    + Biology laboratory X (Animal behaviour) for integrated BS-MS semester VIII, 2016.

    + Biology laboratory VII (Ecology and behaviour) for integrated BS-MS semester VI, 2016.

    + Introduction to Biology II (Evolution) for integrated BS-MS semester II, 2015.

    + Introduction to Biology II (Evolution) for integrated BS-MS semester II, 2014.
...
* **OS:** Windows and Linux (Ubuntu and derivatives). 

* **Programming:** R, LaTeX, Processing, GitHub.

* **Web design:** HTML + CSS, R Markdown

* **Graphic design:** Adobe Photoshop/GIMP, Adobe Illustrator/Inkscape 

* **Media editing:** Avidemux/Openshot, Handbrake/FFmpeg, Audacity etc.
